...
public class ElectrodynamicsWiresPlus {
    ...
    public ElectrodynamicsWiresPlus(IEventBus modEventBus, ModContainer modContainer) {
        ...
        modEventBus.addListener(PurpleWireRegistrar::onRegisterWires);
    ...
    @EventBusSubscriber(modid = ElectrodynamicsWiresPlus.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
